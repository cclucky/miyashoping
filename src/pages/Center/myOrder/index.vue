        ...
        <div class="order-right">
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="record in myOrders.records" 
              :key="record.id">
                <thead>
                  <tr>
                    <th colspan="5">
                      <span class="ordertitle">{{record.createTime}}　订单编号：{{record.outTradeNo}} <span
                          class="pull-right delete"><img src=""></span></span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(orders,index) in record.orderDetailList" :key="orders.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="orders.imgUrl" style="width:100px;heiget:100px">
                    ...
                    <td :rowspan="record.orderDetailList.length" v-if="index==0" width="13%" class="center">
                      <ul class="unstyled">
                        <li>总金额¥{{orders.orderPrice}}.00</li>
                        <li>{{record.orderStatusName}}</li>
...
export default {
    ...
    methods:{
       async getOrder(){
           let {page,limit}=this
         let result = await this.$API.reqGetOrder(page,limit)
         if(result.code==200){
